...
<input type=button onClick="location.href='/phpMyAdmin/PRO/registration2/project.php'" value='MS Thesis/Projects'> 
<input type=button onClick="location.href='/phpMyAdmin/PRO/registration2/register2.php'" value='Registration'>
<br><br>
<br>
<table id="myTable">
  <tr>
...
$sql = "SELECT ID,Student_Name, Thesis_or_Project_Title, Supervisor, (FLOOR(ID/1000000)) Batch FROM project ORDER BY Batch DESC";
